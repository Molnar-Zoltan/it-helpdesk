...
**Live demo:** https://it-helpdesk.zoltanmolnar.eu/ — deployed and under active development, not the final release. Auth and account self-service are live; ticket creation has a working backend API but no frontend yet — see [Roadmap](#roadmap).  
