...
**API docs:** [docs/api-endpoints.md](https://github.com/Molnar-Zoltan/it-helpdesk/blob/main/docs/api-endpoints.md) · Demo login: `user@demo.com` / `agent@demo.com` (see [seed data](#seed-data))
