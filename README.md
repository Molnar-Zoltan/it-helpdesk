...
**Live demo:** https://it-helpdesk.zoltanmolnar.eu/ — deployment planned. The backend API is not deployed yet, and frontend development has not started yet (tracked in [Roadmap](#roadmap)).  
